...
final class UserDetailView: UIView {
    ...
    private func setup() {
        ...
        NSLayoutConstraint.activate([
            ...
            toggleNameButton.topAnchor.constraint(equalTo: addressLabel.bottomAnchor, constant: 24),
            ...
            copyAddressButton.topAnchor.constraint(equalTo: toggleNameButton.bottomAnchor, constant: 12),
            ...
            copyAddressButton.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -20),
            copyAddressButton.heightAnchor.constraint(equalToConstant: 50)
        ])
    }

    @objc private func handleToggleName() {
        delegate?.userDetailViewDidTapToggleName(self)
    }

    @objc private func handleCopyAddress() {
        delegate?.userDetailViewDidTapCopyAddress(self)
    }

    @objc private func handleCameraTap() {
        delegate?.userDetailViewDidTapCamera(self)
    }

    @objc private func handleEdit() {
        delegate?.userDetailViewDidTapEdit(self)
    }
}
